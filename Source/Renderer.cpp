...
void ToolKit::Renderer::Render(Drawable* object, Camera* cam, Light* light)
{
  object->m_mesh->Init();
...
void ToolKit::Renderer::RenderSkinned(Drawable* object, Camera* cam)
{
  object->m_mesh->Init();
  SetProjectViewModel(object, cam);
...
void ToolKit::Renderer::Render2d(Surface* object, glm::ivec2 screenDimensions)
{
  object->Init();
...
void ToolKit::Renderer::BindProgram(std::shared_ptr<Program> program)
{
...
void ToolKit::Renderer::LinkProgram(GLuint program, GLuint vertexP, GLuint fragmentP)
{
...
std::shared_ptr<ToolKit::Renderer::Program> ToolKit::Renderer::CreateProgram(std::shared_ptr<Shader> vertex, std::shared_ptr<Shader> fragment)
{
  assert(vertex);
  assert(fragment);
...
void ToolKit::Renderer::FeedUniforms(std::shared_ptr<Program> program)
{
...
ToolKit::Renderer::Program::Program()
{
}

ToolKit::Renderer::Program::Program(std::shared_ptr<Shader> vertex, std::shared_ptr<Shader> fragment)
{
