...
namespace ToolKit
{
    ...
    void SceneRender(Viewport* viewport)
    {
      ...
      sceneRenderer.m_params.Lights             = GetSceneManager()->GetCurrentScene()->GetLights();
      sceneRenderer.m_params.MainFramebuffer    = viewport->m_framebuffer;
      sceneRenderer.m_params.Scene              = GetSceneManager()->GetCurrentScene();
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            // Init OpenGl.
            g_proxy->m_renderSys->InitGl(SDL_GL_GetProcAddress, [](const String& msg)
              {
