...
namespace ToolKit
{
  class GameViewport : public Viewport
  {
   public:
    ...
    void ContentResize(float width, float height) { OnResizeContentArea(width, height); }
  ...
  void AndroidDevice::InitEGL()
  {
    ...
    const EGLint contextAttribs[] = {EGL_CONTEXT_MAJOR_VERSION, 3, EGL_CONTEXT_MINOR_VERSION, 0, EGL_NONE, EGL_NONE};
  ...
  void AndroidDevice::InitToolkit()
  {
    ...
    proxy->m_renderSys->InitGl(nullptr,
