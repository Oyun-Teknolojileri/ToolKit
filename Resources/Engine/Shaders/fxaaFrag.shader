...
{ 
    ...
    vec2 uv = gl_FragCoord.xy/renderTargetSize.xy; // Normalized pixel coordinates (from 0 to 1)
    ...
    vec3 resultFXAA = applyFXAA(s_texture0, renderTargetSize.xy, gl_FragCoord.xy, renderTargetSize.xy);
