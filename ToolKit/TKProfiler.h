...
// GPU profile
  ...
  static std::unordered_map<String, bool> g_profileTimerSet;
...
#define TKBeginTimer(Name)                                                                                             \
  ...
  if (Name##_i_l)                                                                                                      \
  {                                                                                                                    \
    if (g_profileTimerSet.find(#Name) == g_profileTimerSet.end())                                                      \
      g_profileTimerSet[#Name] = true;                                                                                 \
    Name##_i_l = false;                                                                                                \
  }                                                                                                                    \
