...
namespace ToolKit
{
  namespace Editor
  {
    ...
    SpotLightMeshGenerator::SpotLightMeshGenerator(SpotLight* light)
        : LightMeshGenerator(light)
    {
    }
    ...
    void SpotLightMeshGenerator::InitGizmo()
    {
      ...
      lines[0]->Generate(m_innerCirclePnts,
                         g_lightGizmoColor,
                         DrawType::LineStrip,
                         1.0f);

      lines[1]->Generate(m_outerCirclePnts,
                         g_lightGizmoColor,
                         DrawType::LineStrip,
                         1.0f);
    ...
    DirectionalLightMeshGenerator::DirectionalLightMeshGenerator(
    ...
    PointLightMeshGenerator::PointLightMeshGenerator(PointLight* light)
        : LightMeshGenerator(light)
    {
    }
    ...
    void PointLightMeshGenerator::InitGizmo()
    {
      ...
      auto drawCircleGizmoFn =
          [&pLight, &deltaAngle, &lines, this](Vec3Array vertices,
                                               const Vec3& axis,
                                               const Vec3& perpAxis,
                                               int lineBatchIndex)
      {
        ...
        lines[lineBatchIndex]->Generate(vertices,
                                        g_lightGizmoColor,
                                        DrawType::LineStrip,
                                        1.0f);
      };
