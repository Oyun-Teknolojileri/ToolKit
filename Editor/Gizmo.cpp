...
namespace ToolKit
{
  namespace Editor
  {
    ...
    void SpotLightGizmo::InitGizmo(Light* light)
    {
      ...
      m_gizmoLineBatches[0]->Generate(m_pnts,
                                      g_lightGizmoColor,
                                      DrawType::Line,
                                      1.0f);
      ...
      m_gizmoLineBatches[1]->Generate(m_innerCirclePnts,
                                      g_lightGizmoColor,
                                      DrawType::LineStrip,
                                      1.0f);

      m_gizmoLineBatches[2]->Generate(m_outerCirclePnts,
                                      g_lightGizmoColor,
                                      DrawType::LineStrip,
                                      1.0f);
      ...
      m_gizmoLineBatches[3]->Generate(m_conePnts,
                                      g_lightGizmoColor,
                                      DrawType::Line,
                                      1.0f);
    ...
    void PointLightGizmo::InitGizmo(Light* light)
    {
                                                          ...
                                                          int lineBatchIndex)
      {
        ...
        m_gizmoLineBatches[lineBatchIndex]->Generate(vertices,
                                                     g_lightGizmoColor,
                                                     DrawType::LineStrip,
                                                     1.0f);
      };
